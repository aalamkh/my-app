  ...
  <div className={`form-check form-switch mx-3 text-${props.green ==='light'?'dark':'light'}`}>
    <input className="form-check-input" onClick={props.toggleGreen} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
